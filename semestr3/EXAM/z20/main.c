...
(строки длиной не более 256 символов), лексикографически сортирует массив строк с помощью встроенной 
функции qsort и выводит полученный массив в файл ./t0.txt по одной строке в строку файла.
ПОКА НЕ ДО КОНЦА*/
#include <stdio.h>
#include <stdlib.h>
#include <stdio.h>
