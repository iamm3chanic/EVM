...
(*Тут на сайте есть стороге определение, но его я давать не буду*)  
Скажем, что массив *упорядоченный, если  
...
Структура после удаления корня изменяется, тогда необходимо вновь сделать массив *упорядоченным
...
Конструктор отвечает за инициализацию переменных при создании объекта.  
