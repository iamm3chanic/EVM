...
public:
  ...
  void Clean(){delete[] v; delete[] b; SetZero();} 
  void SetZero(){v=NULL;b=NULL;n=0;nreal=0;}
 ...
 // double& operator[](int index) {return arr[index];}
  ...
  void setB(bool*array);  //без этого никак...
...
public:
	...
	public:
        ...
        friend ostream& operator<<(ostream&cout, CList2 l) {l.GoToBegin();for(;l.GoToNext();){cout<<l.GetCur();} return cout;}
	};
